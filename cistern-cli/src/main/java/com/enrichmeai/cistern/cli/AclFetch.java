...
/**
 * What a {@code GET <resource>.acl} came back with: the ACL and its validator, or nothing there.
 * Sealed, so the walk in {@link RemoteAclDiscovery} pattern-matches rather than testing a
 * nullable.
 */
sealed interface AclFetch permits AclFetch.Found, AclFetch.Absent {
     ...
     * terminates the walk, exactly as {@code AclDiscovery} treats it.
     */
